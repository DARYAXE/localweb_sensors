...
#include <Wire.h>    // use this for I2C
Adafruit_BME180 bmp; // use this for I2C
Adafruit_AHT10 aht;

const char *ssid = "EYESOFPRIESTESS";         // replace with your SSID
const char *password = "whitephospor"; // replace with your Password

AsyncWebServer server(80); // start AsyncWebServer as server at port 80

String readahtTemperature() // returns temperature reading from BME280 as String
{
...
String readahtHumidity() // returns humidity reading from BME280 as String
{
